...
//added in an update by mbrusa
#define _TORQUE_SENSOR_ESTIMATED 0 // This field from javaconfigurator is not present in the HEX file generated by java configurator
