...
#define _TORQUE_SENSOR_ESTIMATED 0
#define _STARTUP_BOOST_AT_ZERO 0
#define _ENABLE_850C 0                          
...
#define _ASSIST_LEVEL_5_PERCENT 60
#define _ALTERNATIVE_MILES 0
#define _PWM_FREQ 19
#define _OVERCURRENT_DELAY 2                 
#define _MOTOR_TYPE_TSDZ8 1
#define _ENABLE_EKD01 0        // 0 no used, 1 enabled
#define _ASSIST_LEVEL_5_MODE 0 // 12C 0=DISABLED 1=BEFORE_ECO 2=AFTER_TURBO
...
typedef struct _config
{
    ...
    uint8_t  torque_sensor_estimated;
    ...
    uint8_t  assist_level_5_percent;
    uint8_t  alternative_miles;
    uint8_t  pwm_freq;
    uint8_t  overcurrent_delay;
    uint8_t motor_type_tsdz8;
    uint8_t enable_ekd01;
    uint8_t assist_level_5_mode; 
} struct_config;
...
extern uint16_t c_BATTERY_VOLTAGE_RESET_SOC_PERCENT_X10 ; 
...
extern uint8_t c_ERROR_OVERVOLTAGE	; //						1 // E01 (E06 blinking for XH18)
extern uint8_t c_ERROR_TORQUE_SENSOR ; //                    	2 // E02
extern uint8_t c_ERROR_CADENCE_SENSOR ; //			          	3 // E03
extern uint8_t c_ERROR_MOTOR_BLOCKED ;//                      	4 // E04
extern uint8_t c_ERROR_THROTTLE ; //								5 // E05 (E03 blinking for XH18)
extern uint8_t c_ERROR_OVERTEMPERATURE	;//					6 // E06
extern uint8_t c_ERROR_BATTERY_OVERCURRENT ;//                	7 // E07 (E04 blinking for XH18)
extern uint8_t c_ERROR_SPEED_SENSOR ;//							8 // E08
extern uint8_t c_ERROR_WRITE_EEPROM ;// 					  	9 // E09 shared (E08 blinking for XH18)
extern uint8_t c_ERROR_MOTOR_CHECK  ;//                     	9 // E09 shared (E08 blinking for XH18)
