            ...
            Integer reserve_3 = 0;
             ...
             Integer reserve_8 = 0;
                 ...
                 try {
                     ...
                     if (RB_MOTOR_36V.isSelected()) { // 14 MOTOR_TYPE 1
                         mWriter.println(mstrensHexLine(1));
                     }
                     if (RB_MOTOR_48V.isSelected()) { // 14 MOTOR_TYPE 0
                     ...
                     if (JCB_DISPLAY_TYPE.getSelectedIndex() == C850) { // 10E ENABLEC850 1
                         mWriter.println(mstrensHexLine(1));
                     }
                     else {                                             //  10E ENABLEC850 0
                         mWriter.println(mstrensHexLine(0));
                     }
