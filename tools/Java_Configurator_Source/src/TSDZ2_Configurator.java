...
public class TSDZ2_Configurator extends javax.swing.JFrame {
    ...
    public void mstrens_generate_hex_file() {        
            ...
            Integer configMainVersion = 3;
            Integer configSubVersion = 0;
            Integer globalOffset = 66;
            Integer reserve_2 = 0;
            Integer reserve_3 = 0;
            Integer reserve_4 = 0;
            Integer reserve_5 = 0;
            ...
            Integer reserve_8 = 0;
                ...
                try {
                    mWriter = new PrintWriter(new BufferedWriter(new FileWriter("files_to_flash/TSDZ8_config.hex")));
                    String text_to_save;
                    ...
                    mWriter.println(mstrensHexLine(globalOffset)); //04
                    mWriter.println(mstrensHexLine(reserve_2));  //06
                    ...
                    if (RB_MOTOR_36V.isSelected()) { //text_to_save = "#define MOTOR_TYPE 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    if (RB_MOTOR_48V.isSelected()) { //text_to_save = "#define MOTOR_TYPE 0";
                        mWriter.println(mstrensHexLine(0));
                    } // 14

                    if (CB_TORQUE_CALIBRATION.isSelected()) { //text_to_save = "#define TORQUE_SENSOR_CALIBRATED 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //        text_to_save = "#define TORQUE_SENSOR_CALIBRATED 0";
                        mWriter.println(mstrensHexLine(0));
                    } //16
                    
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_MOTOR_ACC.getText()))); // 18 MOTOR_ACCELERATION
    
                    if (CB_ASS_WITHOUT_PED.isSelected()) { // text_to_save = "#define MOTOR_ASSISTANCE_WITHOUT_PEDAL_ROTATION 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { // text_to_save = "#define MOTOR_ASSISTANCE_WITHOUT_PEDAL_ROTATION 0";
                        mWriter.println(mstrensHexLine(0));
                    } // 1A
                    ...
                    //mWriter.println(mstrensHexLine(Integer.parseInt(.getText()))); // 
                    
                    if (CB_LIGHTS.isSelected()) { //  text_to_save = "#define ENABLE_LIGHTS 1";
                        mWriter.println(mstrensHexLine(1)); 
                    }
                    else { //                    text_to_save = "#define ENABLE_LIGHTS 0";
                        mWriter.println(mstrensHexLine(0)); 
                    }
                    
                    if (CB_WALK_ASSIST_ENABLED.isSelected()) { //  text_to_save = "#define ENABLE_WALK_ASSIST 1";
                        mWriter.println(mstrensHexLine(1)); 
                    }
                    else { //                       text_to_save = "#define ENABLE_WALK_ASSIST 0";
                        mWriter.println(mstrensHexLine(0)); 
                    }
                    ...
                    if (CB_STREET_MODE_ON_START.isSelected()) { //     text_to_save = "#define ENABLE_STREET_MODE_ON_STARTUP 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                    text_to_save = "#define ENABLE_STREET_MODE_ON_STARTUP 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    if (CB_SET_PARAM_ON_START.isSelected()) { //   text_to_save = "#define ENABLE_SET_PARAMETER_ON_STARTUP 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                        text_to_save = "#define ENABLE_SET_PARAMETER_ON_STARTUP 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    if (CB_ODO_COMPENSATION.isSelected()) { //       text_to_save = "#define ENABLE_ODOMETER_COMPENSATION 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                       text_to_save = "#define ENABLE_ODOMETER_COMPENSATION 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    if (CB_STARTUP_BOOST_ON_START.isSelected()) { //  text_to_save = "#define STARTUP_BOOST_ON_STARTUP 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                         text_to_save = "#define STARTUP_BOOST_ON_STARTUP 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    if (CB_TOR_SENSOR_ADV.isSelected()) { //     text_to_save = "#define TORQUE_SENSOR_ADV_ON_STARTUP 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                        text_to_save = "#define TORQUE_SENSOR_ADV_ON_STARTUP 0";
                        mWriter.println(mstrensHexLine(0));
                    }

                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_LIGHT_MODE_ON_START.getText()))); // LIGHTS_CONFIGURATION_ON_STARTUP
                   
                    if (JCB_ASSIST_MODE_ON_STARTUP.getSelectedIndex() == POWER) { // "#define RIDING_MODE_ON_STARTUP 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    if (JCB_ASSIST_MODE_ON_STARTUP.getSelectedIndex() == TORQUE) { // "#define RIDING_MODE_ON_STARTUP 2";
                        mWriter.println(mstrensHexLine(2));
                    }
                    if (JCB_ASSIST_MODE_ON_STARTUP.getSelectedIndex() == CADENCE) { //  "#define RIDING_MODE_ON_STARTUP 3";
                        mWriter.println(mstrensHexLine(3));
                    }
                    if (JCB_ASSIST_MODE_ON_STARTUP.getSelectedIndex() == EMTB) { //  "#define RIDING_MODE_ON_STARTUP 4";
                        mWriter.println(mstrensHexLine(4));
                    }
                    
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_LIGHT_MODE_1.getText()))); // LIGHTS_CONFIGURATION_1
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_LIGHT_MODE_2.getText()))); // LIGHTS_CONFIGURATION_2
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_LIGHT_MODE_3.getText()))); // LIGHTS_CONFIGURATION_3
                    
                    if (CB_STREET_POWER_LIM.isSelected()) { //   text_to_save = "#define STREET_MODE_POWER_LIMIT_ENABLED 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                         text_to_save = "#define STREET_MODE_POWER_LIMIT_ENABLED 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_STREET_POWER_LIM.getText()))); // STREET_MODE_POWER_LIMIT
                    mWriter.println(mstrensHexLine(Integer.parseInt(String.valueOf(intStreetSpeed)))); // STREET_MODE_SPEED_LIMIT
                    ...
                    else { //                 text_to_save = "#define STREET_MODE_THROTTLE_ENABLED 0";
                        mWriter.println(mstrensHexLine(0));
                    }
    
                    if (CB_STREET_CRUISE.isSelected()) { //            text_to_save = "#define STREET_MODE_CRUISE_ENABLED 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                        text_to_save = "#define STREET_MODE_CRUISE_ENABLED 0";
                        mWriter.println(mstrensHexLine(0));
                    }

                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_ADC_THROTTLE_MIN.getText()))); // ADC_THROTTLE_MIN_VALUE
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_ADC_THROTTLE_MAX.getText()))); // ADC_THROTTLE_MAX_VALUE
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_TEMP_MIN_LIM.getText()))); // MOTOR_TEMPERATURE_MIN_VALUE_LIMIT
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_TEMP_MAX_LIM.getText()))); // MOTOR_TEMPERATURE_MAX_VALUE_LIMIT
                    
                    if (CB_TEMP_ERR_MIN_LIM.isSelected()) { //      text_to_save = "#define ENABLE_TEMPERATURE_ERROR_MIN_LIMIT 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                         text_to_save = "#define ENABLE_TEMPERATURE_ERROR_MIN_LIMIT 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
    
                    if (JCB_DISPLAY_TYPE.getSelectedIndex() == VLCD6) { //          text_to_save = "#define ENABLE_VLCD6 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                         text_to_save = "#define ENABLE_VLCD6 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    if (JCB_DISPLAY_TYPE.getSelectedIndex() == VLCD5) { //          text_to_save = "#define ENABLE_VLCD5 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                         text_to_save = "#define ENABLE_VLCD5 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    if (JCB_DISPLAY_TYPE.getSelectedIndex() == XH18) { //           text_to_save = "#define ENABLE_XH18 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                        text_to_save = "#define ENABLE_XH18 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    
                    if (RB_DISPLAY_WORK_ON.isSelected()) { //           text_to_save = "#define ENABLE_DISPLAY_WORKING_FLAG 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                         text_to_save = "#define ENABLE_DISPLAY_WORKING_FLAG 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    if (RB_DISPLAY_ALWAY_ON.isSelected()) { //      text_to_save = "#define ENABLE_DISPLAY_ALWAYS_ON 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                         text_to_save = "#define ENABLE_DISPLAY_ALWAYS_ON 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    if (CB_MAX_SPEED_DISPLAY.isSelected()) { //  text_to_save = "#define ENABLE_WHEEL_MAX_SPEED_FROM_DISPLAY 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                         text_to_save = "#define ENABLE_WHEEL_MAX_SPEED_FROM_DISPLAY 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_DELAY_MENU.getText()))); // DELAY_MENU_ON
                    
                    if (JCB_BRAKE_FEATURE.getSelectedIndex() == COASTER_BRAKE) { // = "#define COASTER_BRAKE_ENABLED 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                         text_to_save = "#define COASTER_BRAKE_ENABLED 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_COASTER_BRAKE_THRESHOLD.getText()))); // COASTER_BRAKE_TORQUE_THRESHOLD
                    
                    if (CB_AUTO_DISPLAY_DATA.isSelected()) { //      text_to_save = "#define ENABLE_AUTO_DATA_DISPLAY 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                         text_to_save = "#define ENABLE_AUTO_DATA_DISPLAY 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    if (CB_STARTUP_ASSIST_ENABLED.isSelected()) { //     text_to_save = "#define STARTUP_ASSIST_ENABLED 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                         text_to_save = "#define STARTUP_ASSIST_ENABLED 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_DELAY_DATA_1.getText()))); // DELAY_DISPLAY_DATA_1
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_DELAY_DATA_2.getText()))); // DELAY_DISPLAY_DATA_2
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_DELAY_DATA_3.getText()))); // DELAY_DISPLAY_DATA_3
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_DELAY_DATA_4.getText()))); // DELAY_DISPLAY_DATA_4
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_DELAY_DATA_5.getText()))); // DELAY_DISPLAY_DATA_5
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_DELAY_DATA_6.getText()))); // DELAY_DISPLAY_DATA_6
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_DATA_1.getText()))); // DISPLAY_DATA_1
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_DATA_2.getText()))); // DISPLAY_DATA_2
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_DATA_3.getText()))); // DISPLAY_DATA_3
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_DATA_4.getText()))); // DISPLAY_DATA_4
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_DATA_5.getText()))); // DISPLAY_DATA_5
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_DATA_6.getText()))); // DISPLAY_DATA_6
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_POWER_ASS_1.getText()))); // POWER_ASSIST_LEVEL_1
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_POWER_ASS_2.getText()))); // POWER_ASSIST_LEVEL_2
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_POWER_ASS_3.getText()))); // POWER_ASSIST_LEVEL_3
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_POWER_ASS_4.getText()))); // POWER_ASSIST_LEVEL_4
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_TORQUE_ASS_1.getText()))); // TORQUE_ASSIST_LEVEL_1
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_TORQUE_ASS_2.getText()))); // TORQUE_ASSIST_LEVEL_2
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_TORQUE_ASS_3.getText()))); // TORQUE_ASSIST_LEVEL_3
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_TORQUE_ASS_4.getText()))); // TORQUE_ASSIST_LEVEL_3
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_CADENCE_ASS_1.getText()))); // CADENCE_ASSIST_LEVEL_1
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_CADENCE_ASS_2.getText()))); // CADENCE_ASSIST_LEVEL_2
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_CADENCE_ASS_3.getText()))); // CADENCE_ASSIST_LEVEL_3
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_CADENCE_ASS_4.getText()))); // CADENCE_ASSIST_LEVEL_4
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_EMTB_ASS_1.getText()))); // EMTB_ASSIST_LEVEL_1
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_EMTB_ASS_2.getText()))); // EMTB_ASSIST_LEVEL_2
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_EMTB_ASS_3.getText()))); // EMTB_ASSIST_LEVEL_3
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_EMTB_ASS_4.getText()))); // EMTB_ASSIST_LEVEL_4
                    
                    mWriter.println(mstrensHexLine(Integer.parseInt(String.valueOf(intWalkSpeed1)))); // WALK_ASSIST_LEVEL_1
                    mWriter.println(mstrensHexLine(Integer.parseInt(String.valueOf(intWalkSpeed2)))); // WALK_ASSIST_LEVEL_2
                    mWriter.println(mstrensHexLine(Integer.parseInt(String.valueOf(intWalkSpeed3)))); // WALK_ASSIST_LEVEL_3
                    mWriter.println(mstrensHexLine(Integer.parseInt(String.valueOf(intWalkSpeed4)))); // WALK_ASSIST_LEVEL_4
                    
                    mWriter.println(mstrensHexLine(Integer.parseInt(String.valueOf(intWalkSpeedLimit)))); // WALK_ASSIST_THRESHOLD_SPEED_X10
                    
                    if (CB_WALK_TIME_ENA.isSelected()) { //         text_to_save = "#define WALK_ASSIST_DEBOUNCE_ENABLED 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                         text_to_save = "#define WALK_ASSIST_DEBOUNCE_ENABLED 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_WALK_ASS_TIME.getText()))); // WALK_ASSIST_DEBOUNCE_TIME
                    
                    mWriter.println(mstrensHexLine(Integer.parseInt(String.valueOf(intCruiseSpeed1)))); // CRUISE_TARGET_SPEED_LEVEL_1
                    mWriter.println(mstrensHexLine(Integer.parseInt(String.valueOf(intCruiseSpeed2)))); // CRUISE_TARGET_SPEED_LEVEL_2
                    mWriter.println(mstrensHexLine(Integer.parseInt(String.valueOf(intCruiseSpeed3)))); // CRUISE_TARGET_SPEED_LEVEL_3
                    mWriter.println(mstrensHexLine(Integer.parseInt(String.valueOf(intCruiseSpeed4)))); // CRUISE_TARGET_SPEED_LEVEL_4
                    
                    if (CB_CRUISE_WHITOUT_PEDALING.isSelected()) { //     text_to_save = "#define CRUISE_MODE_WALK_ENABLED 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                         text_to_save = "#define CRUISE_MODE_WALK_ENABLED 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    mWriter.println(mstrensHexLine(Integer.parseInt(String.valueOf(intCruiseSpeed)))); // CRUISE_THRESHOLD_SPEED
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_TORQ_ADC_OFFSET.getText()))); // PEDAL_TORQUE_ADC_OFFSET
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_NUM_DATA_AUTO_DISPLAY.getText()))); // AUTO_DATA_NUMBER_DISPLAY
                    ...
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_ASSIST_THROTTLE_MIN.getText()))); // ASSIST_THROTTLE_MIN_VALUE
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_ASSIST_THROTTLE_MAX.getText()))); // ASSIST_THROTTLE_MAX_VALUE
                    
                    if (CB_STREET_WALK.isSelected()) { //         text_to_save = "#define STREET_MODE_WALK_ENABLED 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                         text_to_save = "#define STREET_MODE_WALK_ENABLED 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    if (JCB_ASSIST_MODE_ON_STARTUP.getSelectedIndex() == HYBRID) { //  = "#define RIDING_MODE_ON_STARTUP 5";
                        mWriter.println(mstrensHexLine(5));
                    }
    
                    if (JCB_DATA_ON_STARTUP.getSelectedIndex() == NONE) { //  = "#define DATA_DISPLAY_ON_STARTUP 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    if (JCB_DATA_ON_STARTUP.getSelectedIndex() == SOC) { //  = "#define DATA_DISPLAY_ON_STARTUP 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    
                    if (JCB_DATA_ON_STARTUP.getSelectedIndex() == VOLTS) { //  = "#define DATA_DISPLAY_ON_STARTUP 2";
                        mWriter.println(mstrensHexLine(2));
                    }
    
                    if (CB_FIELD_WEAKENING_ENABLED.isSelected()) { //  = "#define FIELD_WEAKENING_ENABLED 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                                      = "#define FIELD_WEAKENING_ENABLED 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    mWriter.println(mstrensHexLine(Integer.parseInt(String.valueOf(intTorqueOffsetAdj)))); // PEDAL_TORQUE_ADC_OFFSET_ADJ
                    mWriter.println(mstrensHexLine(Integer.parseInt(String.valueOf(intTorqueRangeAdj)))); // PEDAL_TORQUE_ADC_RANGE_ADJ
                    mWriter.println(mstrensHexLine(Integer.parseInt(String.valueOf(intAdcPedalTorqueAngleAdjArray[intTorqueAngleAdj])))); // PEDAL_TORQUE_ADC_ANGLE_ADJ
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_TORQ_PER_ADC_STEP_ADV.getText()))); // PEDAL_TORQUE_PER_10_BIT_ADC_STEP_ADV_X100
                  
                    if (JCB_SOC_CALC.getSelectedIndex() == AUTO) { //      text_to_save = "#define SOC_PERCENT_CALC 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    if (JCB_SOC_CALC.getSelectedIndex() == WH) { //        text_to_save = "#define SOC_PERCENT_CALC 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    
                    if (JCB_SOC_CALC.getSelectedIndex() == VOLTS) { //      text_to_save = "#define SOC_PERCENT_CALC 2";
                        mWriter.println(mstrensHexLine(2));
                    }
                    
                    if (RB_BOOST_AT_ZERO_CADENCE.isSelected()) { //      text_to_save = "#define STARTUP_BOOST_AT_ZERO 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    if (RB_BOOST_AT_ZERO_SPEED.isSelected()) {  //       text_to_save = "#define STARTUP_BOOST_AT_ZERO 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                        
                    if (JCB_DISPLAY_TYPE.getSelectedIndex() == C850) { //  = "#define ENABLEC850 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                         text_to_save = "#define ENABLEC850 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    ...
                    if (JCB_BRAKE_FEATURE.getSelectedIndex() == TEMPERATURE_SWITCH) { //= "#define BRAKE_TEMPERATURE_SWITCH 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                         text_to_save = "#define BRAKE_TEMPERATURE_SWITCH 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    
                    if (RB_eMTB_POWER.isSelected()) { //     text_to_save = "#define eMTB_BASED_ON_POWER 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    
                    if (RB_eMTB_TORQUE.isSelected()) { //    text_to_save = "#define eMTB_BASED_ON_POWER 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    if (CB_SMOOTH_START_ENABLED.isSelected()) { //   text_to_save = "#define SMOOTH_START_ENABLED 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //                     text_to_save = "#define SMOOTH_START_ENABLED 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_SMOOTH_START_RAMP.getText()))); // SMOOTH_START_SET_PERCENT
                    
                    if (JCB_TEMP_SENSOR_TYPE.getSelectedIndex() == LM35) { // text_to_save = "#define TEMPERATURE_SENSOR_TYPE 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    else { //                         text_to_save = "#define TEMPERATURE_SENSOR_TYPE 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    
                    if (CB_CRUISE_ENABLED.isSelected()) { // text_to_save = "#define CRUISE_MODE_ENABLED 1";
                        mWriter.println(mstrensHexLine(1));
                    }
                    else { //    text_to_save = "#define CRUISE_MODE_ENABLED 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    mWriter.println(mstrensHexLine(Integer.parseInt(String.valueOf(JCB_THROTTLE_MODE.getSelectedIndex())))); // THROTTLE_MODE
                    mWriter.println(mstrensHexLine(Integer.parseInt(String.valueOf(JCB_THROTTLE_MODE_STREET.getSelectedIndex())))); // STREET_MODE_THROTTLE_MODE
                    
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_ASS_LEVELS_1_OF_5.getText()))); // ASSIST_LEVEL_1_OF_5_PERCENT
                    ...
                    else { //                         text_to_save = "#define ALTERNATIVE_MILES 0";
                        mWriter.println(mstrensHexLine(0));
                    }
                    
                    if (RB_PWM_18KHZ.isSelected()) { //   text_to_save = "#define PWM_FREQ 18";
                        mWriter.println(mstrensHexLine(18));
                    }
                    if (RB_PWM_19KHZ.isSelected()) { //    text_to_save = "#define PWM_FREQ 19";
                        mWriter.println(mstrensHexLine(19));
                    }
                    
                    mWriter.println(mstrensHexLine(Integer.parseInt(TF_OVERCURRENT_DELAY.getText()))); // OVERCURRENT_DELAY
