...
typedef struct _config
{
    ...
    uint16_t reserve_8;
    uint16_t motor_type;
    uint16_t torque_sensor_calibrated;
    uint16_t motor_acceleration;
    uint16_t motor_assistance_without_pedal_rotation;
    uint16_t assistance_without_pedal_rotation_threshold;
    uint16_t pedal_torque_per_10_bit_adc_step_x100;
    uint16_t pedal_torque_adc_max;
    uint16_t startup_boost_torque_factor;
    uint16_t motor_blocked_counter_threshold;
    uint16_t motor_blocked_battery_current_threshold_x10;
    uint16_t motor_blocked_erps_threshold;
    uint16_t startup_boost_cadence_step;
    uint16_t battery_current_max;
    uint16_t target_max_battery_power;
    uint16_t target_max_battery_capacity;
    uint16_t battery_cells_number;
    uint16_t motor_deceleration;
    uint16_t battery_low_voltage_cut_off;
    uint16_t actual_battery_voltage_percent;
    uint16_t actual_battery_capacity_percent;
    uint16_t li_ion_cell_overvolt;
    uint16_t li_ion_cell_reset_soc_percent;
    uint16_t li_ion_cell_volts_full;
    uint16_t li_ion_cell_volts_3_of_4;
    uint16_t li_ion_cell_volts_2_of_4;
    uint16_t li_ion_cell_volts_1_of_4;
    uint16_t li_ion_cell_volts_5_of_6;
    uint16_t li_ion_cell_volts_4_of_6;
    uint16_t li_ion_cell_volts_3_of_6;
    uint16_t li_ion_cell_volts_2_of_6;
    uint16_t li_ion_cell_volts_1_of_6;
    uint16_t li_ion_cell_volts_empty;
    uint16_t wheel_perimeter;
    uint16_t wheel_max_speed;
    uint16_t enable_lights;
    uint16_t enable_walk_assist;
    uint16_t enable_brake_sensor;
    uint16_t enable_throttle;
    uint16_t enable_temperature_limit;
    uint16_t enable_street_mode_on_startup;
    uint16_t enable_set_parameter_on_startup;
    uint16_t enable_odometer_compensation;
    uint16_t startup_boost_on_startup;
    uint16_t torque_sensor_adv_on_startup;
    uint16_t lights_configuration_on_startup;
    uint16_t riding_mode_on_startup;
    uint16_t lights_configuration_1;
    uint16_t lights_configuration_2;
    uint16_t lights_configuration_3;
    uint16_t street_mode_power_limit_enabled;
    uint16_t street_mode_power_limit;
    uint16_t street_mode_speed_limit;
    uint16_t street_mode_throttle_enabled;
    uint16_t street_mode_cruise_enabled;
    uint16_t adc_throttle_min_value;
    uint16_t adc_throttle_max_value;
    uint16_t motor_temperature_min_value_limit;
    uint16_t motor_temperature_max_value_limit;
    uint16_t enable_temperature_error_min_limit;
    uint16_t enable_vlcd6;
    uint16_t enable_vlcd5;
    uint16_t enable_xh18;
    uint16_t enable_display_working_flag;
    uint16_t enable_display_always_on;
    uint16_t enable_wheel_max_speed_from_display;
    uint16_t delay_menu_on;
    uint16_t coaster_brake_enabled;
    uint16_t coaster_brake_torque_threshold;
    uint16_t enable_auto_data_display;
    uint16_t startup_assist_enabled;
    uint16_t auto_data_number_display;
    uint16_t delay_display_data_1;
    uint16_t delay_display_data_2;
    uint16_t delay_display_data_3;
    uint16_t delay_display_data_4;
    uint16_t delay_display_data_5;
    uint16_t delay_display_data_6;
    uint16_t display_data_1;
    uint16_t display_data_2;
    uint16_t display_data_3;
    uint16_t display_data_4;
    uint16_t display_data_5;
    uint16_t display_data_6;
    uint16_t power_assist_level_1;
    uint16_t power_assist_level_2;
    uint16_t power_assist_level_3;
    uint16_t power_assist_level_4;
    uint16_t torque_assist_level_1;
    uint16_t torque_assist_level_2;
    uint16_t torque_assist_level_3;
    uint16_t torque_assist_level_4;
    uint16_t cadence_assist_level_1;
    uint16_t cadence_assist_level_2;
    uint16_t cadence_assist_level_3;
    uint16_t cadence_assist_level_4;
    uint16_t emtb_assist_level_1;
    uint16_t emtb_assist_level_2;
    uint16_t emtb_assist_level_3;
    uint16_t emtb_assist_level_4;
    uint16_t walk_assist_level_1;
    uint16_t walk_assist_level_2;
    uint16_t walk_assist_level_3;
    uint16_t walk_assist_level_4;
    uint16_t walk_assist_threshold_speed_x10;
    uint16_t walk_assist_debounce_enabled;
    uint16_t walk_assist_debounce_time;
    uint16_t cruise_target_speed_level_1;
    uint16_t cruise_target_speed_level_2;
    uint16_t cruise_target_speed_level_3;
    uint16_t cruise_target_speed_level_4;
    uint16_t cruise_mode_walk_enabled;
    uint16_t cruise_threshold_speed;
    uint16_t pedal_torque_adc_offset;
    uint16_t units_type;
    uint16_t assist_throttle_min_value;
    uint16_t assist_throttle_max_value;
    uint16_t street_mode_walk_enabled;
    uint16_t data_display_on_startup;
    uint16_t field_weakening_enabled;
    uint16_t pedal_torque_adc_offset_adj;
    uint16_t pedal_torque_adc_range_adj;
    uint16_t pedal_torque_adc_angle_adj;
    uint16_t pedal_torque_per_10_bit_adc_step_adv_x100;
    uint16_t soc_percent_calc;
    uint16_t startup_boost_at_zero;
    uint16_t enablec850;
    uint16_t street_mode_throttle_legal;
    uint16_t brake_temperature_switch;
    uint16_t emtb_based_on_power;
    uint16_t smooth_start_enabled;
    uint16_t smooth_start_set_percent;
    uint16_t temperature_sensor_type;
    uint16_t cruise_mode_enabled;
    uint16_t throttle_mode;
    uint16_t street_mode_throttle_mode;
    uint16_t assist_level_1_of_5_percent;
    uint16_t alternative_miles;
} struct_config;
...
#define _ENABLE_LIGHTS 1            // used in and #if!
#define _ENABLE_WALK_ASSIST 1       // 1 enable  // used in and #if!
#define _ENABLE_BRAKE_SENSOR 1                   // used in and #if!
#define _ENABLE_THROTTLE 1          // 1 enable // used in and #if!
...
#define _ENABLE_VLCD6 0                    // used in and #if!
#define _ENABLE_VLCD5 1                    // used in and #if!
#define _ENABLE_XH18 0                     // used in and #if!
#define _ENABLE_DISPLAY_WORKING_FLAG 1     // used in and #if!
#define _ENABLE_DISPLAY_ALWAYS_ON 0        // used in and #if!
#define _ENABLE_WHEEL_MAX_SPEED_FROM_DISPLAY 0 // allow to change the max speed from the display  // used in and #if!
#define _DELAY_MENU_ON 50                  
#define _COASTER_BRAKE_ENABLED 0            // used in and #if!
#define _COASTER_BRAKE_TORQUE_THRESHOLD 30
#define _ENABLE_AUTO_DATA_DISPLAY 1
#define _STARTUP_ASSIST_ENABLED 0          // used in and #if!
...
#define _WALK_ASSIST_DEBOUNCE_ENABLED 0            // used in an #if
...
#define _CRUISE_MODE_WALK_ENABLED 0                // used in an #if
...
#define _UNITS_TYPE 0                        // used in an #if (many)
...
#define _DATA_DISPLAY_ON_STARTUP 1             // used in an #if
#define _FIELD_WEAKENING_ENABLED 0             // used in an #if
...
#define _ENABLEC850 0                          // used in an #if
...
#define _SMOOTH_START_ENABLED 1                // used in an #if
#define _SMOOTH_START_SET_PERCENT 35
#define _TEMPERATURE_SENSOR_TYPE 0            // not used
#define _CRUISE_MODE_ENABLED 1                // used in an #if
...
#define _ALTERNATIVE_MILES 0                 // used in an #if
