...
#define RIDING_MODE_ON_STARTUP 3
...
#define STREET_MODE_THROTTLE_ENABLED 1
#define STREET_MODE_CRUISE_ENABLED 0
#define ADC_THROTTLE_MIN_VALUE 55
...
#define THROTTLE_MODE 4
#define STREET_MODE_THROTTLE_MODE 4
